#
#  Be sure to run `pod spec lint CenterTextLayer.podspec' to ensure this is a
...
```
  ...
  s.homepage     = "https://github.com/cemolcay/CenterTextLayer"
  ...
  s.source       = { :git => "https://github.com/cemolcay/CenterTextLayer.git", :tag => "#{s.version}" }
